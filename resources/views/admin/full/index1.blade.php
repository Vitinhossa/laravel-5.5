...
@section('title', 'Gate 01')

@section('content_header')
    <h1>Gate Geradas - 01</h1>

    <ol class="breadcrumb">
        <li><a href="">Dashboard</a></li>
        <li><a href="">Gate - 01 </a></li>
    </ol>
@stop
...
<div class="wrapper">
    ...
    padding-top: 20px;"></i></a><a href="#"><i class="pe-7s-close"></i></a>
                            ...
                            <div class="row">
		<div class="col-md-12"><br><p> Formato: 5493910434220110|07|25|256 </p>
